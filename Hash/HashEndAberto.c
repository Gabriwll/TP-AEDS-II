...
//TODO: Alterar nomes de variáveis
//TODO: Estruturar um TAD para Hash
//TODO: Fragmentar o código da Hash, tornando a lista encadeada um componente independente dessa estrutura
...
void GeraPesos(TipoPesos p){ /* -Gera valores randomicos entre 1 e 10.000- */
    ...
    for (i = 0; i < N; i++) p[i] = 1 + (int) (10000.0 * rand()/(RAND_MAX + 1.0));
}
...
void Imprime(TipoDicionario tabela){
    ...
    for (i = 0; i < M; i++){
        ...
        for (j = 0; j < tam; j++) putchar(tabela[i].Chave[j]);
        putchar('\n');
    }
}  /* Imprime */
...
//Sugestão: Manter o main comentado e adaptá-lo para um ambiente de testes pensado no intuito do tp